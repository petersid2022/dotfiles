...
vim.keymap.set({ "n", "v" }, "<leader>y", [["+y]], { desc = "Neovim: Copy to system clipboard" })

vim.keymap.set({ "n", "v" }, "<leader>Y", [["+Y]], { desc = "Neovim: Copy to system clipboard" })

vim.keymap.set({ 'n', 'v' }, 'x', '"_x', { desc = nil })

vim.keymap.set("n", "<leader>r", [[:%s/\<<C-r><C-w>\>/<C-r><C-w>/gI<Left><Left><Left>]],
    { desc = "Neovim: Replace word using Regex" })

vim.keymap.set("v", "J", ":m '>+1<CR>gv=gv", { silent = true, desc = nil })
vim.keymap.set("v", "K", ":m '<-2<CR>gv=gv", { silent = true, desc = nil })
vim.keymap.set("v", "Ξ", ":m '>+1<CR>gv=gv", { silent = true, desc = nil })
vim.keymap.set("v", "Κ", ":m '<-2<CR>gv=gv", { silent = true, desc = nil })

vim.keymap.set("n", "<C-d>", "<C-d>zz", { silent = true, desc = nil })
vim.keymap.set("n", "<C-u>", "<C-u>zz", { silent = true, desc = nil })

vim.keymap.set({ "n", "v" }, ".", "<nop>", { silent = true, desc = nil })
vim.keymap.set({ "n", "v" }, "<C-m>", "<nop>", { silent = true, desc = nil })
...
vim.keymap.set('t', '<esc><esc>', '<c-\\><c-n>', { noremap = true, silent = true, desc = nil })
