-- ended up using telescope for this 
--
-- require("trouble").setup {}
-- vim.keymap.set("n", "<leader>t", function() require("trouble").toggle() end)
-- vim.keymap.set("n", "<leader>ww", function() require("trouble").toggle("workspace_diagnostics") end)
-- vim.keymap.set("n", "<leader>dw", function() require("trouble").toggle("document_diagnostics") end)
--
